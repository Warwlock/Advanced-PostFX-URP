Shader "Hidden/_Pulse_MultipleCamera"
{
    HLSLINCLUDE
        ...
        half4 fragColor(Varyings input) : SV_Target
        {
            ...
            {
                half2 coord = input.texcoord + i * dir * texel;
                total += SAMPLE_TEXTURE2D_X(_MaskTexture, _sampler_Linear_Clamp, coord);
            }*/

            return lerp(oldCol, col, mask.r);
        }
